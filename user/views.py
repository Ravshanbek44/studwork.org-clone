...
from user.serializers import RegisterSerializer, LoginSerializer, VerifySerializer, \
    VerifyRegisterSerializer, ChangePasswordSerializer, ResetPasswordSerializer, UserSerializer, SubjectTypeSerializer, \
    SubjectSerializer
from user.models import Account, VerifyPhone, Subject, SubjectType
...
class SubjectTypeListAPIView(generics.ListAPIView):
